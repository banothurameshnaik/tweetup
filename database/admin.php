...
if(isset($_POST['wtd']) && $_POST['wtd'] == "delete" && $_POST['table'] == "Users")
{
...
if(isset($_POST['wtd']) && $_POST['wtd'] == "delete" && $_POST['table'] == "Messages")
{
...
if($sql)
	...
	echo "not delete_success";
}
if(isset($_POST['wtd']) && $_POST['wtd'] == "delete" && $_POST['table'] == "Feedback")
{
...
if(isset($_POST['wtd']) && $_POST['wtd'] == "delete" && $_POST['table'] == "Forum")
{
